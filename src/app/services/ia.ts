...
export class IaService {
  ...
  const configuracion = {
    ...
    capacidadCarros:
    localStorage.getItem('capacidad_carros'),

    capacidadMotos:
    localStorage.getItem('capacidad_motos'),

    tarifaCarro:
    localStorage.getItem('config_carro'),

    tarifaMoto:
    localStorage.getItem('config_moto')
  };
...

    {
      ...
      messages: [

        {
          ...
          content:
          'Eres una IA inteligente especializada en parqueaderos.'
        },
